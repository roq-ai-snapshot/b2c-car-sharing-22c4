  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to B2C Car Sharing v1 - Where individual customers meet their perfect ride, available right around the corner, managed seamlessly by our dedicated operations team."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to B2C Car Sharing v1 - Where individual customers meet their perfect ride, available right around the corner, managed seamlessly by our dedicated operations team.`}
            </Text>
            <Box
